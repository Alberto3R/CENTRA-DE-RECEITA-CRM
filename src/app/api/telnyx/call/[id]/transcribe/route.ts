...
/**
 * POST /api/telnyx/call/[id]/transcribe — transcreve a gravação da ligação
 * PSTN (Telnyx) e salva em telnyx_calls.transcript. Idempotente. Admin+.
 * Espelha a rota do WhatsApp; muda só a tabela.
 */
